...
import { VAddButton } from '@ui/button/addButton/addButton';
import { VInput } from '@ui/input/input';
import { VInteresInputFull } from '@ui/input/interesInput/interesInput';
import { VList } from '@ui/list/list';
import { VInteres } from '@ui/option/interest/interes';
